...
export const Contect = () => {
  return (
    <div className="w-full h-screen bg-zinc-800 flex p-20">
      <div className="w-1/2 h-full flex flex-col justify-between  font-['Founders_Grotesk_X_Condensed']">
      ...
      <div className="w-1/2 font-['Founders_Grotesk_X_Condensed'] ">
        <h1 className=" text-[5vw] font-semibold uppercase ">presentations</h1>
        ...
        <div className="flex  flex-col mt-20">
          <h6>L:</h6>
          {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item)=>(
            <a href="#">{item}</a>
          )) }
        </div>
